...
namespace ḏḥwtj
{
    public class MyWindow : EditorWindow
    {
        ...
        [MenuItem("Thoth/Flag System/Setup Scene")]
        static void Init()
        {
            ...
            Texture icon = AssetDatabase.LoadAssetAtPath<Texture>("Assets/Thoth/Editor/Flags/recursos/Logo.png");
        ...
        [MenuItem("Thoth/Support/Website")]
        ...
        void OnGUI()
        {
            ...
            if (GUILayout.Button("Import Complete Flag Manager", GUILayout.Width(200), GUILayout.Height(25)))
            {
                ...
                flagManager = (GameObject)PrefabUtility.InstantiatePrefab(AssetDatabase.LoadAssetAtPath<GameObject>("Assets/Thoth/Editor/Flags/recursos/[SceneManager].prefab"));
