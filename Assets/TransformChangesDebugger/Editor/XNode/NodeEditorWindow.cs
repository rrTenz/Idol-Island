...
namespace TransformChangesDebugger.Editor.XNode {
    ...
    public partial class NodeEditorWindow : EditorWindow {
        ...
        public Dictionary<global::XNode.NodePort, Rect> portConnectionPoints { get { return _portConnectionPoints; } }
        private Dictionary<global::XNode.NodePort, Rect> _portConnectionPoints = new Dictionary<global::XNode.NodePort, Rect>();
        ...
        [System.Serializable] private class NodePortReference {
            [SerializeField] private global::XNode.Node _node;
            [SerializeField] private string _name;

            public NodePortReference(global::XNode.NodePort nodePort) {
                _node = nodePort.node;
                _name = nodePort.fieldName;
            }

            public global::XNode.NodePort GetNodePort() {
                if (_node == null) {
                    return null;
                }
        ...
        private void OnEnable() {
            ...
            if (length == _rects.Length) {
                for (int i = 0; i < length; i++) {
                    global::XNode.NodePort nodePort = _references[i].GetNodePort();
                    if (nodePort != null)
        ...
        public Dictionary<global::XNode.Node, Vector2> nodeSizes { get { return _nodeSizes; } }
        private Dictionary<global::XNode.Node, Vector2> _nodeSizes = new Dictionary<global::XNode.Node, Vector2>();
        public global::XNode.NodeGraph graph;
        ...
        private static void OnSelectionChanged() {
            global::XNode.NodeGraph nodeGraph = Selection.activeObject as global::XNode.NodeGraph;
        ...
        public void SaveAs() {
            ...
            if (string.IsNullOrEmpty(path)) return;
                ...
                global::XNode.NodeGraph existingGraph = AssetDatabase.LoadAssetAtPath<global::XNode.NodeGraph>(path);
        ...
        public void SelectNode(global::XNode.Node node, bool add) {
            if (add) {
        ...
        public void DeselectNode(global::XNode.Node node) {
            List<Object> selection = new List<Object>(Selection.objects);
        ...
        public static bool OnOpen(int instanceID, int line) {
            global::XNode.NodeGraph nodeGraph = EditorUtility.InstanceIDToObject(instanceID) as global::XNode.NodeGraph;
            if (nodeGraph != null) {
                Open(nodeGraph);
                return true;
            }
        ...
        public static NodeEditorWindow Open(global::XNode.NodeGraph graph) {
