...
namespace TransformChangesDebugger.Editor.XNode {
    ...
    [CustomNodeGraphEditor(typeof(global::XNode.NodeGraph))]
    public class NodeGraphEditor : NodeEditorBase<NodeGraphEditor, NodeGraphEditor.CustomNodeGraphEditorAttribute, NodeGraph> {
        ...
        public virtual string GetNodeMenuName(Type type) {
            ...
            global::XNode.Node.CreateNodeMenuAttribute attrib;
        ...
        public virtual void AddContextMenuItems(GenericMenu menu) {
            ...
            for (int i = 0; i < nodeTypes.Length; i++) {
                ...
                if (disallowed) menu.AddItem(new GUIContent(path), false, null);
                    ...
                    global::XNode.Node node = CreateNode(type, pos);
        ...
        public virtual Gradient GetNoodleGradient(global::XNode.NodePort output, global::XNode.NodePort input) {
        ...
        /// <param name="output"> The output this noodle comes from. Never null. </param>
        /// <param name="input"> The output this noodle comes from. Can be null if we are dragging the noodle. </param>
        public virtual float GetNoodleThickness(global::XNode.NodePort output, global::XNode.NodePort input) {
            return 5f;
        }

        public virtual NoodlePath GetNoodlePath(global::XNode.NodePort output, global::XNode.NodePort input) {
            return NodeEditorPreferences.GetSettings().noodlePath;
        }

        public virtual NoodleStroke GetNoodleStroke(global::XNode.NodePort output, global::XNode.NodePort input) {
            return NodeEditorPreferences.GetSettings().noodleStroke;
        }

        /// <summary> Returned color is used to color ports </summary>
        public virtual Color GetPortColor(global::XNode.NodePort port) {
        ...
        public virtual string GetPortTooltip(global::XNode.NodePort port) {
        ...
        public virtual global::XNode.Node CreateNode(Type type, Vector2 position) {
            Undo.RecordObject(target, "Create Node");
            global::XNode.Node node = target.AddNode(type);
        ...
        public virtual global::XNode.Node CopyNode(global::XNode.Node original) {
            Undo.RecordObject(target, "Duplicate Node");
            global::XNode.Node node = target.CopyNode(original);
        ...
        public virtual bool CanRemove(global::XNode.Node node) {
            // Check graph attributes to see if this node is required
            Type graphType = target.GetType();
            global::XNode.NodeGraph.RequireNodeAttribute[] attribs = Array.ConvertAll(
                graphType.GetCustomAttributes(typeof(global::XNode.NodeGraph.RequireNodeAttribute), true), x => x as global::XNode.NodeGraph.RequireNodeAttribute);
        ...
        public virtual void RemoveNode(global::XNode.Node node) {
