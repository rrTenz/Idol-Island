...
namespace TransformChangesDebugger.Editor.XNode {
    ...
    public class RenamePopup : EditorWindow {
        ...
        private void OnGUI() {
            ...
            UnityEngine.GUI.SetNextControlName(inputControlName);
            ...
            if (input == null || input.Trim() == "") {
                if (GUILayout.Button("Revert to default") || (e.isKey && e.keyCode == KeyCode.Return)) {
                    ...
                    NodeEditor.GetEditor((global::XNode.Node)target, NodeEditorWindow.current).OnRename();
                    AssetDatabase.SetMainObject((target as global::XNode.Node).graph, AssetDatabase.GetAssetPath(target));
