...
namespace TransformChangesDebugger.Editor.XNode {
    ...
    class NodeEditorAssetModProcessor : UnityEditor.AssetModificationProcessor {
        ...
        private static AssetDeleteResult OnWillDeleteAsset (string path, RemoveAssetOptions options) {
            ...
            if (scriptType == null || (scriptType != typeof (global::XNode.Node) && !scriptType.IsSubclassOf (typeof (global::XNode.Node)))) return AssetDeleteResult.DidNotDelete;
            ...
            for (int i = 0; i < guids.Length; i++) {
                ...
                for (int k = 0; k < objs.Length; k++) {
                    global::XNode.Node node = objs[k] as global::XNode.Node;
        ...
        private static void OnReloadEditor () {
            ...
            string[] guids = AssetDatabase.FindAssets ("t:" + typeof (global::XNode.NodeGraph));
            for (int i = 0; i < guids.Length; i++) {
                string assetpath = AssetDatabase.GUIDToAssetPath (guids[i]);
                global::XNode.NodeGraph graph = AssetDatabase.LoadAssetAtPath (assetpath, typeof (global::XNode.NodeGraph)) as global::XNode.NodeGraph;
                ...
                for (int u = 0; u < objs.Length; u++) {
                    ...
                    if (!graph.nodes.Contains (objs[u] as global::XNode.Node)) graph.nodes.Add(objs[u] as global::XNode.Node);
                }
            }
        }
    }
